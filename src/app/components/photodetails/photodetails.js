            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 p-10 ">
                ...
                <div className="flex justify-start mt-5">
                    ...
                    <div className="flex mr-2">
                        <a href="/en/Login">
                            <div>
                                <img src="https://cdn0.iconfinder.com/data/icons/small-n-flat/24/678087-heart-256.png" alt="redHeart" className="w-12 sm:w-8 h-12 sm:h-8" />
                            </div>
                        </a>
